 ...
 * @author Bilal
 */
public class ViewTransactionLog extends javax.swing.JFrame {

    /**
     * Creates new form ViewTransactionLog
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewTransactionLog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewTransactionLog().setVisible(true);
            }
        });
    }
